...
var Sentry = (function (exports) {
      ...
      fill(global$2, 'fetch', function (originalFetch) {
          return function (...args) {
              ...
              return originalFetch.apply(global$2, args).then((response) => {
                  triggerHandlers('fetch', Object.assign(Object.assign({}, commonHandlerData), { endTimestamp: Date.now(), response }));
                  return response;
              }, (error) => {
                  triggerHandlers('fetch', Object.assign(Object.assign({}, commonHandlerData), { endTimestamp: Date.now(), error }));
  ...
  class BaseClient {
      ...
      _prepareEvent(event, scope, hint) {
          ...
          const prepared = Object.assign(Object.assign({}, event), { event_id: event.event_id || (hint && hint.event_id ? hint.event_id : uuid4()), timestamp: event.timestamp || timestampWithMs() });
